...
export const initialRestaurantsData = {
  "rest-1": {
    ...
    menu: [
      { id: "menu-1", name: "Paneer Tikka", category: "Starters", price: 180, gst: 5, desc: "Marinated cottage cheese cubes grilled in charcoal tandoor with onions and bell peppers.", image: "https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?w=500&auto=format&fit=crop&q=60", available: true, veg: true, bestseller: true, chefSpecial: true, prepTime: 15, allowSpecialInstructions: true, stockQuantity: 40, minStockThreshold: 5 },
      { id: "menu-2", name: "Chicken Biryani", category: "Rice Meals", price: 320, gst: 5, desc: "Fragrant basmati rice layered with juicy spiced chicken, saffron, and fresh mint.", image: "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=500&auto=format&fit=crop&q=60", available: true, veg: false, bestseller: true, chefSpecial: true, prepTime: 20, allowSpecialInstructions: true, stockQuantity: 35, minStockThreshold: 5 },
      { id: "menu-3", name: "Masala Dosa", category: "Tiffin", price: 120, gst: 5, desc: "Thin crispy rice crepe filled with spiced potato mash. Served with sambar and coconut chutney.", image: "https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=500&auto=format&fit=crop&q=60", available: true, veg: true, bestseller: true, chefSpecial: false, prepTime: 12, allowSpecialInstructions: true, stockQuantity: 50, minStockThreshold: 10 },
      { id: "menu-4", name: "Dal Makhani", category: "Rice Meals", price: 160, gst: 5, desc: "Creamy slow-cooked black lentils simmered overnight with butter, cream, and tomatoes.", image: "https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=500&auto=format&fit=crop&q=60", available: true, veg: true, bestseller: false, chefSpecial: true, prepTime: 15, allowSpecialInstructions: true, stockQuantity: 25, minStockThreshold: 5 },
      { id: "menu-full-meals", name: "Full Meals", category: "Rice Meals", price: 120, gst: 5, desc: "Rice, sambar, rasam, 3 curries, papad, pickle & payasam", image: "https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=500&auto=format&fit=crop&q=60", available: true, veg: true, bestseller: true, chefSpecial: false, prepTime: 10, allowSpecialInstructions: true, stockQuantity: 60, minStockThreshold: 10 },
      { id: "menu-mini-meals", name: "Mini Meals", category: "Rice Meals", price: 90, gst: 5, desc: "Rice, sambar, 1 curry, papad & pickle", image: "https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=500&auto=format&fit=crop&q=60", available: true, veg: true, bestseller: false, chefSpecial: false, prepTime: 8, allowSpecialInstructions: true, stockQuantity: 45, minStockThreshold: 8 },
      { id: "menu-5", name: "Gulab Jamun", category: "Desserts", price: 80, gst: 5, desc: "Golden fried milk-solid dumplings dipped in warm cardamom-scented sugar syrup.", image: "https://images.unsplash.com/photo-1589301760014-d929f3979dbc?w=500&auto=format&fit=crop&q=60", available: true, veg: true, bestseller: false, chefSpecial: false, prepTime: 5, allowSpecialInstructions: false, stockQuantity: 30, minStockThreshold: 5 },
      { id: "menu-6", name: "Masala Chai", category: "Drinks", price: 40, gst: 5, desc: "Traditional brewed black tea infused with cardamom, ginger, cloves, and milk.", image: "https://images.unsplash.com/photo-1576092768241-dec231879fc3?w=500&auto=format&fit=crop&q=60", available: true, veg: true, bestseller: false, chefSpecial: false, prepTime: 5, allowSpecialInstructions: true, stockQuantity: 100, minStockThreshold: 15 },
      { id: "menu-7", name: "Butter Naan", category: "Rotis", price: 40, gst: 5, desc: "Soft leavened tandoori flatbread brushed with generous butter.", image: "https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=500&auto=format&fit=crop&q=60", available: true, veg: true, bestseller: false, chefSpecial: false, prepTime: 8, allowSpecialInstructions: true, stockQuantity: 80, minStockThreshold: 10 },
      { id: "menu-8", name: "Lassi", category: "Drinks", price: 60, gst: 5, desc: "Chilled yogurt beverage blended sweet with cardamom and rose water.", image: "https://images.unsplash.com/photo-1553530666-ba11a7da3888?w=500&auto=format&fit=crop&q=60", available: true, veg: true, bestseller: false, chefSpecial: false, prepTime: 5, allowSpecialInstructions: true, stockQuantity: 40, minStockThreshold: 5 }
    ],
    orders: [
      { id: "847", branchId: "BR-001", table: "03", time: "1:28 PM", timeAgo: "2 min ago", items: [{ name: "Chicken Biryani", qty: 1, price: 320, prepTime: 20 }, { name: "Masala Chai", qty: 2, price: 40, prepTime: 5 }], spiceLevel: "Less Spicy", specialInstructions: "Less spicy please, no extra chilli", notes: "Less spicy please", subtotal: 400, tax: 20, charge: 0, total: 420, status: "new", billingStatus: "unpaid", waiter: "Unassigned" },
      { id: "846", branchId: "BR-001", table: "07", time: "1:22 PM", timeAgo: "8 min ago", items: [{ name: "Chicken Biryani", qty: 4, price: 320, prepTime: 20 }, { name: "Dal Makhani", qty: 3, price: 160, prepTime: 15 }, { name: "Paneer Tikka", qty: 1, price: 180, prepTime: 15 }, { name: "Masala Chai", qty: 2, price: 40, prepTime: 5 }], spiceLevel: "Medium Spicy", specialInstructions: "Medium spicy", notes: "", subtotal: 2020, tax: 101, charge: 0, total: 2121, status: "preparing", billingStatus: "unpaid", waiter: "Ravi M." },
      { id: "845", branchId: "BR-001", table: "01", time: "1:15 PM", timeAgo: "15 min ago", items: [{ name: "Masala Dosa", qty: 5, price: 120, prepTime: 12 }, { name: "Filter Coffee", qty: 3, price: 40, prepTime: 5 }], spiceLevel: "Less Spicy", specialInstructions: "Allergy: peanuts", notes: "Allergy: peanuts", subtotal: 720, tax: 36, charge: 0, total: 756, status: "preparing", billingStatus: "unpaid", waiter: "Rahul S." },
      { id: "844", branchId: "BR-002", table: "05", time: "1:08 PM", timeAgo: "22 min ago", items: [{ name: "Paneer Tikka", qty: 2, price: 180, prepTime: 15 }, { name: "Chicken Biryani", qty: 1, price: 320, prepTime: 20 }, { name: "Butter Naan", qty: 3, price: 40, prepTime: 8 }, { name: "Masala Chai", qty: 2, price: 40, prepTime: 5 }], spiceLevel: "Extra Spicy", specialInstructions: "Extra crispy naan", notes: "", subtotal: 880, tax: 44, charge: 0, total: 924, status: "ready", billingStatus: "unpaid", waiter: "Arjun K." },
      { id: "843", branchId: "BR-003", table: "02", time: "1:00 PM", timeAgo: "30 min ago", items: [{ name: "Veg Thali", qty: 2, price: 120, prepTime: 10 }, { name: "Masala Chai", qty: 3, price: 40, prepTime: 5 }], spiceLevel: "Medium Spicy", specialInstructions: "", notes: "", subtotal: 360, tax: 18, charge: 0, total: 378, status: "done", billingStatus: "paid", waiter: "Ravi M." },
      { id: "842", branchId: "BR-001", table: "02", time: "12:55 PM", timeAgo: "35 min ago", items: [{ name: "Chicken Biryani", qty: 2, price: 320, prepTime: 20 }, { name: "Dal Makhani", qty: 2, price: 160, prepTime: 15 }, { name: "Paneer Tikka", qty: 1, price: 180, prepTime: 15 }, { name: "Masala Chai", qty: 1, price: 40, prepTime: 5 }], spiceLevel: "Medium Spicy", specialInstructions: "", notes: "", subtotal: 1180, tax: 59, charge: 0, total: 1239, status: "done", billingStatus: "unpaid", waiter: "Ravi M." }
    ],
    waiterRequests: [
      { id: "WR-101", branchId: "60a1b2c3d4e5f6a7b8c9d0e1", table: "05", requestType: "Call Waiter", requestTime: "1:25 PM", timeAgo: "5 min ago", status: "Pending", assignedWaiterId: "S-03", assignedWaiterName: "Anitha Selvam", assignedStaff: "Anitha Selvam", notes: "Assistance requested at table" },
      { id: "WR-102", branchId: "60a1b2c3d4e5f6a7b8c9d0e1", table: "03", requestType: "Call Waiter", requestTime: "1:20 PM", timeAgo: "10 min ago", status: "Accepted", assignedWaiterId: "S-01", assignedWaiterName: "Ramesh Kumar", assignedStaff: "Ramesh Kumar", notes: "Assistance with dessert recommendation", acceptedTime: "1:22 PM" },
      { id: "WR-103", branchId: "60a1b2c3d4e5f6a7b8c9d0e1", table: "02", requestType: "Call Waiter", requestTime: "1:10 PM", timeAgo: "20 min ago", status: "Completed", assignedWaiterId: "S-06", assignedWaiterName: "Ravi M.", assignedStaff: "Ravi M.", notes: "Assisted with bill payment", acceptedTime: "1:12 PM", completedTime: "1:16 PM", duration: "4 mins" },
      { id: "WR-104", branchId: "60a1b2c3d4e5f6a7b8c9d0e2", table: "07", requestType: "Call Waiter", requestTime: "1:05 PM", timeAgo: "25 min ago", status: "Completed", assignedWaiterId: "S-03", assignedWaiterName: "Anitha Selvam", assignedStaff: "Anitha Selvam", notes: "Extra water and glasses", acceptedTime: "1:06 PM", completedTime: "1:10 PM", duration: "4 mins" },
      { id: "WR-105", branchId: "60a1b2c3d4e5f6a7b8c9d0e1", table: "01", requestType: "Call Waiter", requestTime: "12:50 PM", timeAgo: "40 min ago", status: "Completed", assignedWaiterId: "S-01", assignedWaiterName: "Ramesh Kumar", assignedStaff: "Ramesh Kumar", notes: "Extra cutlery requested", acceptedTime: "12:51 PM", completedTime: "12:55 PM", duration: "4 mins" }
    ],
    serviceRequests: [
      { id: "WR-101", branchId: "60a1b2c3d4e5f6a7b8c9d0e1", table: "05", requestType: "Call Waiter", requestedTime: "1:25 PM", timeAgo: "5 min ago", status: "Pending", assignedStaff: "Anitha Selvam", notes: "Assistance requested at table" },
      { id: "WR-102", branchId: "60a1b2c3d4e5f6a7b8c9d0e1", table: "03", requestType: "Call Waiter", requestedTime: "1:20 PM", timeAgo: "10 min ago", status: "Accepted", assignedStaff: "Ramesh Kumar", notes: "Assistance with dessert recommendation" },
      { id: "WR-103", branchId: "60a1b2c3d4e5f6a7b8c9d0e1", table: "02", requestType: "Call Waiter", requestedTime: "1:10 PM", timeAgo: "20 min ago", status: "Completed", assignedStaff: "Ravi M.", notes: "Assisted with bill payment" },
      { id: "WR-104", branchId: "60a1b2c3d4e5f6a7b8c9d0e2", table: "07", requestType: "Call Waiter", requestedTime: "1:05 PM", timeAgo: "25 min ago", status: "Completed", assignedStaff: "Anitha Selvam", notes: "Extra water and glasses" },
      { id: "WR-105", branchId: "60a1b2c3d4e5f6a7b8c9d0e1", table: "01", requestType: "Call Waiter", requestedTime: "12:50 PM", timeAgo: "40 min ago", status: "Completed", assignedStaff: "Ramesh Kumar", notes: "Extra cutlery requested" }
    ],
    feedback: [
      { id: "FB-201", branchId: "BR-001", orderId: "847", table: "03", customerName: "Aarav Sharma", phone: "9876543210", foodRating: 5, serviceRating: 5, overallRating: 5.0, comments: "The Chicken Biryani was absolutely flavorful! Outstanding service by the staff.", date: "2026-08-20", time: "1:35 PM", status: "Reviewed" },
      { id: "FB-202", branchId: "BR-001", orderId: "843", table: "02", customerName: "Meera Patel", phone: "9876543211", foodRating: 5, serviceRating: 4, overallRating: 4.5, comments: "Loved the crisp Masala Dosa and fresh Chai. Quick delivery to table.", date: "2026-08-20", time: "1:15 PM", status: "Reviewed" },
      { id: "FB-203", branchId: "BR-001", orderId: "842", table: "02", customerName: "Sanjay Reddy", phone: "9876543212", foodRating: 4, serviceRating: 4, overallRating: 4.0, comments: "Dal Makhani was rich and creamy. Tandoori Paneer Tikka was fresh.", date: "2026-08-20", time: "1:05 PM", status: "Reviewed" },
      { id: "FB-204", branchId: "BR-002", orderId: "844", table: "05", customerName: "Kavita Menon", phone: "9876543213", foodRating: 5, serviceRating: 5, overallRating: 5.0, comments: "Very clean restaurant, smooth digital ordering via QR code.", date: "2026-08-19", time: "8:30 PM", status: "Reviewed" },
      { id: "FB-205", branchId: "BR-001", orderId: "836", table: "04", customerName: "Dinesh Kumar", phone: "9876543214", foodRating: 4, serviceRating: 5, overallRating: 4.5, comments: "Paneer Butter Masala was very good. Friendly staff.", date: "2026-08-19", time: "1:40 PM", status: "Reviewed" }
    ],
    tables: [
